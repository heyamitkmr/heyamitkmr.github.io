...
### **About me**
<p>I'm exploring the intersection of <b>creation, learning, and connection.</b> </p>
<p>More than anything, I want to make: articles, essays, books, software, systems, and ideas that help people think differently about their lives and work.</p>
<p>I work best in focused, uninterrupted stretches: deep dives into one thing until it feels complete. Whether that's a 12-hour coding session, a week of writing, or months building a product. I'm single-focused, not scattered. Or at least I'm striving to be that person.</p>
...
You probably encountered my work without knowing it at:
    ...
    - Modern reporting for Human Capital Management _(17% chance your US-based company uses it)_
    - NLP solutions for data de-duplication and survey analysis
    - ServiceNow platform analytics _(if you've raised a support ticket at work, there's a good chance)_
...
<p>I'm a minimalist with my time, attention, and tools. I use what works: simple text editors, open-source tools, distraction-free environments. I avoid dependency on platforms or companies that don't align with my long-term interests.</p>
...
### **Life philosophy**
<p>I'm skeptical of fixed beliefs - the opposite of what I believe is probably also true. But I live by a few consistent principles:</p>
...
- **[Dailyish](https://earlynotes.substack.com/p/showing-up-dailyish) is consistent.** You don't need perfection. 3-4 times a week is real consistency.
...
**Public living room concept.** No-hustle spaces where people gather around ideas. Still forming. Looking for the right people in Bangalore. [Let's talk](#lets-talk) if that interests you too.
...
**Running.** Recently did 21km in 2 hours 17 minutes. Nothing record-breaking. But mine. [Read about it](https://world.hey.com/akumar/showing-up-dailyish-0568c517).
